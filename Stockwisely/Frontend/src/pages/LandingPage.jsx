      ...
      <div className="min-h-screen flex items-center justify-center p-8 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 space-y-8">
            ...
            StockWisely uses the power of Support Vector Machine (SVM) bulid with the MERN stack to predict stock prices accurately. Stay ahead in the market with data-driven insights and real-time stock tracking
            </p>
          ...
          <div className="flex-1 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-orange-100">
            {isLogin ? (
